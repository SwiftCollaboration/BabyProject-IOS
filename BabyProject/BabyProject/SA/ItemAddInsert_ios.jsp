...
<%
	String imageSavePath = "/Library/Tomcat/webapps/ROOT/bebeProject/image/";
	int imgSizeLimit = 10 * 1024 * 1024;
	MultipartRequest multi = new MultipartRequest(request, imageSavePath, imgSizeLimit, new DefaultFileRenamePolicy());
